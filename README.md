...
Two-part notebook:  
1. Supervised learning on a **heart-disease** dataset including cleaning, encoding, scaling, and cross-validated models (logistic, KNN, NB, SVM, RF, GB) with a full performance analysis.  
...
ES is most accurate and robust, GA is the most stable, PSO fastest but prone to stalling, illustrating exploration-exploitation trade-offs.
