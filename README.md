...
Compares lightweight pretrained models across hubs for NLP (IMDb) and CV (CIFAR-10): **Hugging Face**, **PyTorch Hub**, **TF Hub**, and a scikit-learn baseline. Standardized preprocessing, fixed budgets, linear-probe vs light fine-tune. Reports F1 and F1/min with reproducible code and Apple-silicon tips.
